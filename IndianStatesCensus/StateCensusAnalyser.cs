...
namespace IndianStatesCensus
{
    public class StateCensusAnalyser
    {
        ...
        public StateCensusAnalyser(string path = @"C:\Users\DEEPAK\OneDrive\Desktop\RFP _.NET Fellowship - 142\Day29_IndianCensus\IndianStatesCensus\IndianStatesCensus\StateCensusData.csv")
        {
            this.filePath = path;
        }
        /// <summary>
